...
const pt = {
  ...
  spotlight: {
    badge: "Nova Grande Atualização",
    versionTag: "v2.5.0",
    title: "Automation Engineer entrou no time",
    subtitle:
      "O framework ganhou um engenheiro de automações profissional, um orquestrador mais inteligente e um padrão de qualidade visual que elimina de vez a cara de IA genérica.",
    item1Title: "Novo agente: /automation-engineer",
    item1Desc: "Automação de processos em qualquer linguagem: planilhas, browser, API e ETL com validação, idempotência, retries e dry-run.",
    item2Title: "13 agentes, 202 skills",
    item2Desc: "13 skills dedicadas ao novo agente elevaram o framework a 13 agentes especializados e 202 skills modulares.",
    item3Title: "Orquestrador otimizado",
    item3Desc: "Novo protocolo em 3 passos: estudar o pedido, comparar agentes por necessidade real e executar em paralelo, sem redundância.",
    item4Title: "Zero cara de IA",
    item4Desc: "Regra oficial do framework: sem travessões decorativos, sem emojis e sem gradientes roxos. Paleta fria e tipografia precisa.",
    item5Title: "Qualquer linguagem",
    item5Desc: "Automações não são só Python: TypeScript, C#, Go, Bash e mais, escolhidas pelo problema e pelo ambiente.",
    ctaTitle: "Experimente agora",
    ctaDesc: "Inicie com npx izanagi init e acione o novo agente com /automation-engineer.",
    ctaGithub: "Ver no GitHub",
    ctaAgents: "Ver agentes",
  },
  guide: {
...
const en: Dict = {
  ...
  spotlight: {
    badge: "Major Update",
    versionTag: "v2.5.0",
    title: "Automation Engineer joins the team",
    subtitle:
      "The framework gained a professional automation engineer, a smarter orchestrator and a visual quality standard that kills generic AI looks for good.",
    item1Title: "New agent: /automation-engineer",
    item1Desc: "Process automation in any language: spreadsheets, browser, API and ETL with validation, idempotency, retries and dry-run.",
    item2Title: "13 agents, 202 skills",
    item2Desc: "13 dedicated skills for the new agent brought the framework to 13 specialized agents and 202 modular skills.",
    item3Title: "Optimized orchestrator",
    item3Desc: "New 3-step protocol: study the request, compare agents by real need and execute in parallel with zero redundancy.",
    item4Title: "Zero AI-look",
    item4Desc: "Official framework rule: no decorative em-dashes, no emojis and no purple gradients. Cool palette and precise typography.",
    item5Title: "Any language",
    item5Desc: "Automations are not Python-only: TypeScript, C#, Go, Bash and more, chosen by the problem and the environment.",
    ctaTitle: "Try it now",
    ctaDesc: "Start with npx izanagi init and trigger the new agent with /automation-engineer.",
    ctaGithub: "View on GitHub",
    ctaAgents: "View agents",
  },
  guide: {
    back: "Back to Home",
...
const es: Dict = {
  ...
  spotlight: {
    badge: "Nueva Gran Actualización",
    versionTag: "v2.5.0",
    title: "Automation Engineer se une al equipo",
    subtitle:
      "El framework ganó un ingeniero de automatización profesional, un orquestador más inteligente y un estándar de calidad visual que elimina de una vez la cara de IA genérica.",
    item1Title: "Nuevo agente: /automation-engineer",
    item1Desc: "Automatización de procesos en cualquier lenguaje: hojas de cálculo, navegador, API y ETL con validación, idempotencia, retries y dry-run.",
    item2Title: "13 agentes, 202 skills",
    item2Desc: "13 skills dedicadas al nuevo agente elevaron el framework a 13 agentes especializados y 202 skills modulares.",
    item3Title: "Orquestador optimizado",
    item3Desc: "Nuevo protocolo en 3 pasos: estudiar la petición, comparar agentes por necesidad real y ejecutar en paralelo, sin redundancia.",
    item4Title: "Cero cara de IA",
    item4Desc: "Regla oficial del framework: sin guiones decorativos, sin emojis y sin gradientes morados. Paleta fría y tipografía precisa.",
    item5Title: "Cualquier lenguaje",
    item5Desc: "Las automatizaciones no son solo Python: TypeScript, C#, Go, Bash y más, elegidas por el problema y el entorno.",
    ctaTitle: "Pruébalo ahora",
    ctaDesc: "Inicia con npx izanagi init y activa el nuevo agente con /automation-engineer.",
